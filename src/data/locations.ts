 ...
 *
 * `popularAreas` is filled in for the launch cities only — those are the
 * neighbourhood names people actually search ("plumber in Lekki"), and they
 * feed the search synonyms rather than becoming their own routes.
 */
...
export type SeedState = {
  ...
  lgas: string[];
  popularAreas?: Record<string, string[]>;
};
...
export const STATES: SeedState[] = [
  ...
  },
  {
    ...
    popularAreas: {
      "Municipal Area Council": [
        "Wuse", "Wuse 2", "Maitama", "Asokoro", "Garki", "Utako", "Jabi", "Gwarinpa",
        "Life Camp", "Katampe", "Lugbe", "Durumi", "Apo", "Kubwa", "Karu", "Nyanya", "Jahi", "Mabushi",
      ],
    },
  },
  {
  ...
  },
  {
    ...
    popularAreas: {
      "Eti-Osa": [
        "Lekki Phase 1", "Ikate", "Agungi", "Ikota", "Chevron", "Victoria Island",
        "Ikoyi", "Oniru", "Osapa London", "Jakande", "Ajah", "Badore", "Ilasan",
      ],
      "Ibeju-Lekki": ["Sangotedo", "Awoyaya", "Bogije", "Lakowe", "Eleko", "Abijo"],
      Ikeja: ["Allen Avenue", "Opebi", "Oregun", "Alausa", "Maryland", "Ogba", "Ojodu", "GRA Ikeja"],
      Alimosho: ["Ikotun", "Egbeda", "Idimu", "Igando", "Akowonjo", "Ipaja", "Ayobo"],
      Surulere: ["Aguda", "Ijesha", "Itire", "Lawanson", "Ojuelegba", "Masha"],
      Kosofe: ["Ketu", "Ogudu", "Ojota", "Magodo", "Alapere", "Mile 12"],
      "Lagos Mainland": ["Yaba", "Ebute Metta", "Sabo", "Iwaya", "Makoko"],
      "Amuwo-Odofin": ["Festac Town", "Mile 2", "Satellite Town", "Amuwo"],
      "Oshodi-Isolo": ["Isolo", "Ejigbo", "Okota", "Ilasamaja", "Mafoluku"],
      Ikorodu: ["Ikorodu Town", "Ijede", "Igbogbo", "Imota", "Agric"],
      Ifako: ["Agbado", "Iju", "Fagba"],
      "Lagos Island": ["Marina", "Obalende", "Idumota", "Broad Street"],
    },
  },
  {
    name: "Nasarawa",
  ...
  },
  {
    ...
    popularAreas: {
      "Port Harcourt": ["GRA Phase 1", "GRA Phase 2", "GRA Phase 3", "D-Line", "Old GRA", "Trans Amadi", "Diobu"],
      "Obio/Akpor": ["Rumuokoro", "Rumuola", "Rumuigbo", "Woji", "Ozuoba", "Choba", "Rukpokwu", "Eliozu"],
    },
  },
  {
    name: "Sokoto",
...
export const TOTAL_STATE_COUNT = STATES.length;
export const TOTAL_LGA_COUNT = STATES.reduce((sum, s) => sum + s.lgas.length, 0);
